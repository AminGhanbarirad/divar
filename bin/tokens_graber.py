...
cur.execute('CREATE TABLE tokens_T(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE , token_C TEXT , title_C TEXT , status_C TEXT , cost_C TEXT , store_C TEXT , comment_C TEXT)')
...
while True:
    ...
    for widget in data['web_widgets']['post_list']:
        ...
        cost = widget['data']['middle_description_text']
        store = widget['data']['red_text']

        print('token =' , token, 'title =' ,title , 'status :' , status , 'cost :' , cost)
        cur.execute('INSERT INTO tokens_T(token_C, title_C, status_C, cost_C, store_C) VALUES (?, ?, ?, ?, ?)',
